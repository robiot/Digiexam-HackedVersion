...
svgEditor.addExtension('shapes', function() {'use strict';
	...
	// These are all the different shapes in the flyout menu
	function makeButtons(cat, shapes) {
		...
		var shape_icon = new DOMParser().parseFromString(
			'<svg xmlns="http://www.w3.org/2000/svg"><svg viewBox="' + vb + '"><path fill="'+(fill?'#f00':'none')+'" stroke="#f00" stroke-width="' + stroke + '" /></svg></svg>',
			'text/xml');
